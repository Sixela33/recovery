    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 px-6 pt-12 pb-6 text-white">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-xl">Guardian Management</h1>
        </div>
        ...
        <Card className="bg-white/10 backdrop-blur border-white/20 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg">Wallet Protected</h3>
      ...
      <div className="px-6 py-6">
        ...
        {/* Guardians List */}
        <div>
          <h3 className="mb-4">Your Guardians</h3>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">{guardian.joinedDate}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Badge 
        ...
        <Card className="p-6 mt-6 bg-blue-50 border-blue-200">
          <div className="text-center">
            ...
            <h3 className="text-lg mb-2 text-blue-900">Recovery Requirements</h3>
        ...
        <Card className="p-4 mt-6 border-orange-200 bg-orange-50">
          <div className="text-center">
            <p className="text-orange-800 mb-3">Want to test your recovery process?</p>
            <Button 
              variant="outline" 
              size="sm"
