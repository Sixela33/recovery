    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`px-6 pt-12 pb-6 text-white ${
        ...
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-xl">Recovery Progress</h1>
        </div>
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className={`text-sm ${isComplete ? 'text-green-200' : 'text-blue-200'}`}>
            ...
            <div className="text-right">
              ...
              <div className={`text-xs ${isComplete ? 'text-green-200' : 'text-blue-200'}`}>
                Approved
              </div>
            </div>
          </div>
        ...
        {isComplete ? (
          <Card className="p-6 mb-6 bg-green-50 border-green-200">
            <div className="text-center">
              ...
              <h3 className="text-lg mb-2 text-green-900">Recovery Approved!</h3>
          ...
          <Card className="p-6 mb-6 bg-blue-50 border-blue-200">
            <div className="text-center">
              ...
              <h3 className="text-lg mb-2 text-blue-900">Recovery in Progress</h3>
        ...
        <Card className="p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-sm">Sarah Kim approved your recovery</p>
            ...
            <div className="flex items-start space-x-3">
              <div className="w-2 h-2 bg-green-500 rounded-full mt-2" />
              <div>
                <p className="text-sm">Mike Johnson approved your recovery</p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-sm">Emma Wilson is reviewing your request</p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-sm">Recovery request sent to guardians</p>
