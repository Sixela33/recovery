    ...
    <div className="min-h-screen bg-gray-50 w-full">
      ...
      <div className="bg-gradient-to-r from-orange-500 to-red-500 px-6 pt-12 pb-6 text-white">
        <div className="flex items-center mb-6">
          ...
          <h1 className="screen-title text-xl">Wallet Recovery</h1>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur rounded-lg p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="card-header text-lg">Lost Access?</h3>
              <p className="small-text text-orange-200">We'll help you get back in safely</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-6">
        ...
        <Card className="p-6 mb-6 text-center">
          ...
          <h2 className="screen-title text-xl mb-3">Don't worry!</h2>
        ...
        <Card className="p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="small-text mb-1">Request Help</p>
                <p className="tiny-text text-gray-500">We'll notify your guardians that you need assistance</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 text-sm mt-0.5">2</div>
              <div>
                <p className="small-text mb-1">Guardian Approval</p>
                <p className="tiny-text text-gray-500">3 of your guardians will verify your identity and approve</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 text-sm mt-0.5">3</div>
              <div>
                <p className="small-text mb-1">Access Restored</p>
                <p className="tiny-text text-gray-500">You'll regain full access to your wallet and funds</p>
              </div>
            </div>
          </div>
        </Card>
          ...
          <div className="grid grid-cols-5 gap-3">
            {[
              ...
              <div key={index} className="text-center">
                ...
                <p className="tiny-text text-gray-600">{guardian.name}</p>
              </div>
            ))}
          </div>
          <p className="tiny-text text-gray-500 text-center mt-4">
        ...
        <Card className="p-4 mb-6 bg-blue-50 border-blue-200">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="small-text text-blue-900 mb-1">Your funds are always safe</p>
              <p className="tiny-text text-blue-700 leading-relaxed">
        ...
        <div className="mt-6 text-center">
          <p className="small-text text-gray-500 mb-3">Other options</p>
